      ...
      <div className="relative max-w-4xl mx-auto">
        ...
        <div className="bg-slate-800/30 backdrop-blur-sm rounded-2xl p-6 sm:p-8 mb-8 border border-slate-700/50 max-w-2xl mx-auto">
          ...
          <InteractiveHoverButton 
            ...
            text="ENTER"
            className="w-48 h-14 bg-slate-900 hover:bg-gradient-to-r hover:from-yellow-600 hover:to-yellow-500 text-white font-bold text-lg rounded-2xl shadow-lg hover:shadow-yellow-500/20 border border-slate-700 hover:border-yellow-500/30 transition-all duration-300"
          />
