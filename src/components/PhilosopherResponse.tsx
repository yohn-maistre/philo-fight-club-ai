...
export const PhilosopherResponse = ({
  philosopher,
  onContinue,
  onNewChallenge
}: PhilosopherResponseProps) => {
  const responses = {
    Nietzsche: {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex justify-center gap-4">
          <Button onClick={onNewChallenge} className="bg-gradient-to-r from-red-600 to-red-500 hover:from-red-500 hover:to-red-400 text-white font-semibold px-6 py-3">
            <Mic className="h-4 w-4 mr-2" />
            Follow-up Challenge
          </Button>
          
          <Button onClick={onContinue} variant="outline" className="border-slate-600 text-slate-300 hover:bg-slate-700 hover:text-white font-semibold px-6 py-3">
            📝 Let Debate Continue
